	...
	<div class="container-fluid">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="index.php">
				...
				<img alt="40e Congrès de l'APLIUT" style="height: 100%; text-align: center;" class="nav-logo" src="images/apliut-logo.jpg" />
			</a>
		</div>
			...
			<ul class="navbar-nav" id="bs-example-navbar-collapse-1">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						...
						<li><a href="colloque2018.php#programme">Programme</a></li>
  ...
  <div class="carousel-inner" role="listbox">
      ...
      <div class="item">
        ...
        <div class="carousel-caption">
          <section class="carousel_legend carousel_legend_9">
            <h4>Du 31 mai au 2 juin 2018</h4>
          </section>
        </div>
      </div>
      ...
      <div class="item">
        ...
        <div class="carousel-caption">
          <section class="carousel_legend carousel_legend_10">
            <h4>L'internationalisation des formations</h4>
          </section>
        </div>
      </div>
      ...
      <div class="item">
        ...
        <div class="carousel-caption">
          <section class="carousel_legend carousel_legend_11">
            <h4>Du 31 mai au 2 juin 2018</h4>
          </section>
        </div>
      </div>
      ...
      <div class="item">
        ...
        <div class="carousel-caption">
          <section class="carousel_legend carousel_legend_12">
            <h4>La place du Capitole</h4>
          </section>
        </div>
      </div>
				...
				<div class="present-text">
					<p>
													<strong>Jeudi 31 Mai</strong><br />
														...
														<strong>Samedi 02 Juin</strong><br />
												</p>
