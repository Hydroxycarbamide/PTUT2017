...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../css/max1630px.css"
          media="screen and (min-width: 1445px) and (max-width: 1630px)"></link>
    <link rel="stylesheet" type="text/css" href="../css/max1445px.css"
          media="screen and (min-width: 1280px) and (max-width: 1445px)"></link>
    <link rel="stylesheet" type="text/css" href="../css/max1280px.css"
          media="screen and (min-width: 1032px) and (max-width: 1280px)"></link>
    <link rel="stylesheet" type="text/css" href="../css/max1032px.css"
          media="screen and (min-width: 768px) and (max-width: 1032px)"></link>
            ...
            <form action="colloque2018.php" method="post">
                ...
                foreach ($presentationColloque as $pre) { ?>
                    <textarea cols="100" rows="1"
                              name="<?php echo 'titremodifier' . $n; ?>"><?php echo "$pre[0]"; ?></textarea>
                    <br/>
                    <textarea cols="100" rows="6"
                              name="<?php echo 'textemodifier' . $n; ?>"><?php echo "$pre[1]"; ?></textarea>
                    <input type="hidden" name="<?php echo 'idPC' . $n; ?>" value="<?php echo $pre[2]; ?>"/>
                ...
                <br/>
                <button type="submit" name="enregsitrerPresentation">Enregistrer</button>
            </form>
            <?php
        } else {
            //récupère toute la présentation du colloque?>
            <form action="colloque2018.php" method="post" name="bouton">
                <button type="submit" name="boutonModifPresentation"><img src="../images/modifier.png" width="50"
                                                                          height="50"/></button>
                <button type="submit" name="AjouterPresentation">Ajouter une partie</button>
                <button type="submit" name="SupprimerPresentation">Supprimer une partie</button>
                <br/>
...
>>>>>>> Stashed changes
    ...
    <div class="conteneur conteneur-colloque conteneur-colloque-conferencies" id="conferencies">
        ...
        if (isset($_POST['ModifierIntervenant'])) {
            ...
            <form action="colloque2018.php" method="post" enctype="multipart/form-data">
                <!-- enctype par default tetxe. ici précise que il y a un fichier-->
                <?php
                $i = 0;
                foreach ($Intervenants as $data) {
                    ...
                    <br/>
                    <img src="<?php echo '../' . $data[4]; ?>" class="conferencies-photo conferencies-photo1"
                    ...
                    <div class="figcaption-div figcaption-div-gauche">
                        ...
                        <p class="figcaption-p-info conferencies-nom"><textarea cols="20" rows="1"
                                                                                name="<?php echo 'nom' . $i; ?>"><?php echo $data[1]; ?></textarea>
                        </p>
                    </div>

                    <div class="figcaption-div figcaption-div-droite">
                        <h4 class="conferencies-h4">Prenom</h4>
                        <p class="figcaption-p-info conferencies-prenom"><textarea cols="20" rows="1"
                                                                                   name="<?php echo 'prenom' . $i; ?>"><?php echo $data[2]; ?></textarea>
                        </p>
                    </div>
                    <div class="figcaption-div">
                        <h4 class="conferencies-h4">Description / Specialité(s)</h4>
                        <p class="conferencies-biographie"><textarea cols="20" rows="10"
                                                                     name="<?php echo 'des' . $i; ?>"><?php echo $data[3]; ?></textarea>
                        </p>
                    </div>
                    <?php
                    $i++;
            ...
            <form action="colloque2018.php" method="post">
                ...
                <button type="submit" name="SupprimerIntervenant">Supprimer un intervenant</button>
                <br/>
                <?php
                foreach ($Intervenants as $data) {
                    ?>
                    ...
                    <figure class="conferencies-fig">
                        ...
                        <figcaption>
                            <div class="figcaption-div figcaption-div-gauche">
                                <h4 class="conferencies-h4">Nom</h4>
                                <p class="figcaption-p-info conferencies-nom"><?php echo $data[1]; ?> </p>
                            </div>
                            <div class="figcaption-div figcaption-div-droite">
                                <h4 class="conferencies-h4">Prenom</h4>
                                <p class="figcaption-p-info conferencies-prenom"><?php echo $data[2]; ?></p>
                            </div>
                            <div class="figcaption-div">
                                <h4 class="conferencies-h4">Description / Specialité(s)</h4>
        ...
        if (isset($_POST['AjouterIntervenant'])) {
            ...
            <form action="colloque2018.php" method="post" enctype="multipart/form-data">
                ...
                <div class="figcaption-div figcaption-div-gauche">
                    <h4 class="conferencies-h4">Nom</h4>
                    <p class="figcaption-p-info conferencies-nom"><textarea cols="20" rows="1" name="nomA"></textarea>
                    </p>
                </div>
                <div class="figcaption-div figcaption-div-droite">
                    <h4 class="conferencies-h4">Prenom</h4>
                    <p class="figcaption-p-info conferencies-prenom"><textarea cols="20" rows="1"
                                                                               name="prenomA"></textarea></p>
                </div>
                <div class="figcaption-div">
                    <h4 class="conferencies-h4">Description / Specialité(s)</h4>
        ...
        <div class="conteneur conteneur-colloque conteneur-colloque-programme" id="programme">
            ...
            if (isset($_POST['modifierAteliers'])) {
                                ...
                                <table class="table table-striped">
                                    ...
                                    while ($infoAtelier = $Atelier->fetch()) {
                                        ...
                                        <tr>
                                            ...
                                            <td><textarea cols="20" rows="2"
                                                          name="<?php echo "textmodifier1" . $ligne; ?>"><?php echo "$infoAtelier[0]"; ?></textarea>
                                            </td>
                                            <td><textarea cols="20" rows="2"
                                                          name="<?php echo "textmodifier2" . $ligne; ?>"><?php echo "$infoAtelier[1]"; ?></textarea>
                                            </td>
                                            <td><textarea cols="20" rows="2"
                                                          name="<?php echo "textmodifier3" . $ligne; ?>"><?php echo "$infoAtelier[2]"; ?></textarea>
                                            </td>
                                            <td><textarea cols="30" rows="2"
                                                          name="<?php echo "textmodifier4" . $ligne; ?>"><?php echo "$infoAtelier[3]"; ?></textarea>
                                            </td>
                                            <td><textarea cols="30" rows="10"
                                                          name="<?php echo "textmodifier5" . $ligne; ?>"><?php echo "$infoAtelier[4]"; ?></textarea>
                                            </td>
                                            <input type="hidden" name="<?php echo 'idA' . $ligne; ?>"
                                                   value="<?php echo $infoAtelier[5]; ?>"/>
                                        </tr>
                                        <?php $i++;
                                    } ?>
                                </table>
                ...
                <form action="colloque2018.php" method="post" name="Ateliers">
                    <button type="submit" name="modifierAteliers"><img src="../images/modifier.png" width="50"
                                                                       height="50"/></button>
                            ...
                            if (!$AtelierExecute) {
                                ...
                                <table class="table table-striped">
                                    ...
                                    <?php while ($infoAtelier = $Atelier->fetch()) {
                                        ?>
                                        <tr>
                                            <td><input type="radio" name="AtelierASupprimer"
                                                       value="<?php echo $infoAtelier[0]; ?>"/></td>
        ...
        <div class="conteneur conteneur-colloque conteneur-colloque-programme" id="conferences">
            ...
            if (isset($_POST['modifierConferences'])) {
                            ...
                            if (!$ConferenceExecute) {
                                ...
                                <table class="table table-striped">
                                    ...
                                    while ($infoConference = $Conference->fetch()) {
                                        ?>
                                        <tr>
                                            <?php $ligne = "Ligne" . $i . $dateConference[1]; ?>
                                            <td><textarea cols="20" rows="2"
                                                          name="<?php echo "textmodifier1" . $ligne; ?>"><?php echo "$infoConference[0]"; ?></textarea>
                                            </td>
                                            <td><textarea cols="20" rows="2"
                                                          name="<?php echo "textmodifier2" . $ligne; ?>"><?php echo "$infoConference[2]"; ?></textarea>
                                            </td>
                                            <td><textarea cols="20" rows="2"
                                                          name="<?php echo "textmodifier3" . $ligne; ?>"><?php echo "$infoConference[1]"; ?></textarea>
                                            </td>
                                            ...
                                            if (!$intervenantExecute) {
                                                ...
                                                <td><textarea cols="40" rows="2"
                                                              name="<?php echo "textmodifier4" . $ligne; ?>"><?php echo "$intervenantLu[0] $intervenantLu[1]"; ?></textarea>
                                                </td>
                                                <input name="<?php echo 'idConf' . $ligne; ?>"
                                                       value="<?php echo $infoConference[5]; ?>"/>
                                                <?php
                                            } ?>                                </tr>
                                        <?php $i++;
                                    }//fin while
                ...
                <form action="colloque2018.php" method="post" name="Conferences">
                    <button type="submit" name="modifierConferences"><img src="../images/modifier.png" width="50"
                                                                          height="50"/></button>
                            ...
                            if (!$ConferenceExecute) {
                                ...
                                <table class="table table-striped">
                                    ...
                                    <?php while ($infoConference = $Conference->fetch()) {
                                        ?>
                                        <tr>
                                            <td><input type="radio" name="ConferenceASupprimer"
                                                       value="<?php echo $infoConference[0]; ?>"/></td>
                                            ...
                                            if (!$intervenantExecute) {
                                                ...
                                                $intervenantLu = $intervenant->fetch(); ?>
                                                <td><?php echo "$intervenantLu[0] $intervenantLu[1]"; ?></td>
                                                <?php
                                            } ?>
                                        </tr>
                                        <?php
                ...
                <form method="post" action="colloque2018.php">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td><textarea cols="40" rows="2" name="Theme"></textarea></td>
                            <td><textarea cols="20" rows="10" name="Description"></textarea></td>
                            <td><textarea cols="20" rows="2" name="Intervenant" placeholder="ex: nom prénom"></textarea>
                            </td>
                        </tr>
                    </table>
                    <button type="submit" name="EnregistrerNouvelleConference">Enregistrer la nouvelle conference
                    </button>
                </form>
                <?php
            }
